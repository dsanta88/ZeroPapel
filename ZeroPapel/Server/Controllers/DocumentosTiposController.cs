...
namespace ZeroPapel.Server.Controllers
{
    ...
    public class DocumentosTiposController : ControllerBase
    {
        ...
        public IActionResult Get(int empresaId, int id)
        {
            ...
            try
            {
                List<DocumentoTipo> list = datos.DocumentosTiposObtener(empresaId, id);
        ...
        public IActionResult DocumentosTiposValidarCodigo(int empresaId, int codigo)
        {
            Response response = new Response();
            try
            {
                Validacion valid = datos.DocumentosTiposValidarCodigo(empresaId, codigo);
                response.IsSuccessful = true;
                response.Data = valid;
            }
            catch (Exception ex)
